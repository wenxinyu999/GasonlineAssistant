...
//界面控件
    ...
    Spinner sp_check;
    ListView lv_message;
    ImageView chech_back;
    LinearLayout customBarChart2;
    ImageView chech_sure;
   ...
   private long exitTime=0;
    ...
    private void initView(){
        ...
        currentmongth=(ImageView) findViewById(R.id.check_currentmonth);
    ...
    private void sp_jian(){
       ...
       sb.append(syear).append("年").append(smonth).append("月").append(sday).append("日");
        ...
        if (judge.equals("yes")) {
            ...
            check_totalin.setText("总加油量： "+String.valueOf(db.inoutdata(check_acc_num,check_date,"金额")/10)+"L ");
            check_totalout.setText("总金额：" + String.valueOf( db.inoutdata(check_acc_num,check_date,"金额"))+"元");
            //Barchar();
           // paintzhe();
            //paintzhe2();
        }
